...
public class ArvoreAVL<G extends Comparable<G>> {
	...
	private NoAVL<G> balanceamento(NoAVL<G> no) {
		...
		if (fb == +2) {
			...
			/*
			 * Verificação do fator de balanceamento do nó direito e aplicação da rotação à
			...
			/*
			 * Verificação do fator de balanceamento do nó esquerdo e aplicação da rotação à
