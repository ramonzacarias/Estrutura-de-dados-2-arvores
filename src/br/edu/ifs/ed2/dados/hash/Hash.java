...
public abstract class Hash<G> {
	 ...
	 * de espalhamento. Essa fase deve ser implementada nas classes concretas, haja
	 * vista que depende da estrutura de endereçaamento da tabela de espalhamento
	 * (e.g., endereçaamento aberto, endereçaamento encadeado).
	 * 
	...
	public boolean remover(G conteudo) {
		...
		/*
		 * Obtenção do éndice do conteúdo.
		 */
	...
	/**
	 * Método que altera a estratágia de construção de chaves.
	 * 
